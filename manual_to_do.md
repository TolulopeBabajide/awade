...
- [ ] Push develop to GitHub to trigger CI for AWD-M-65 (remove TestPage.tsx debug page, commits 359b4a5 / merge 631e45b). Also run locally: `rm apps/frontend/src/pages/TestPage.tsx` then `git add apps/frontend/src/pages/TestPage.tsx && git commit -m "chore(frontend): AWD-M-65 remove physical TestPage.tsx file"` then push.
