...
| 2026-06-14 | AWD-M-218 | fix(ci): add AI_PROVIDER: mock to backend-test env — prevents AwadeGPTService from defaulting to openai provider during CI test runs. Commit TBD, merge TBD. |
