...
| 2026-05-18 | AWD-M-185 | Extract _build_guide_ai_payload(child, topic) and _persist_guide(child_id, topic_id, ai_content) helpers from generate_guide in ChildrenService; CC reduced 12→~5; 9 new tests in TestBuildGuideAIPayloadM185 + TestPersistGuideM185 | commit 5e9d05f |
