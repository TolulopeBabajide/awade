...
def signup(
    ...
    user_response = UserResponse(
        ...
        profile_image_data=getattr(user, 'profile_image_data', None),
        profile_image_type=getattr(user, 'profile_image_type', None),
...
def get_current_user_profile(
    ...
    return UserResponse(
        ...
        profile_image_type=getattr(current_user, 'profile_image_type', None),
